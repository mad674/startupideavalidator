...
const GoogleLogin = async (req, res, next) => {
  try {
    ...
    const appToken = jwt.sign({ id: user._id }, process.env.JWT_SECRET, { expiresIn: process.env.JWT_EXPIRE || '1d' });
    res.status(200).json({
      success: true,
      message: 'Login successful',
      token : appToken,
...
module.exports = { GoogleLogin,ResetPasswordOtp,ForgotPassword,getuserapikey,checkApiKey,setApiKey,getAllUsers, register, login, getUserDetails, updateUserDetails, deleteUser };
